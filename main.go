...
func main() {
	...
	NICK := "faggotbot"
	CHANNEL := "#laidback"
	bannedwords := []string{"xD", "facebook", "tumblr", "haha aa", "bajsar", "skiter", "hehe mm", "kek", "pepsi max", "SSD är värdelös", "dkn ingen fv", "9gag", "flash xss", "jag bor i stockholm", "hipster", "åkesson", "deepweb", "antivirus", "ebin", "yolo", "jålå", "yålå", "swag", "sväg", "swäg", "meme", "feminis", "patriarkat", "bajsrunk"}
