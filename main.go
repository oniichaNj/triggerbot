...
func main() {
	...
	NICK := "faggotbot"
	CHANNEL := "#laidback"
	bannedwords := []string{"facebook", "tumblr", "bajsar", "skiter", "hehe mm", "kek", "pepsi max", "SSD är värdelös", "dkn ingen fv", "9gag", "flash xss", "jag bor i stockhol", "hipster", "åkesson", "antivirus", "ebin", "yolo", "jålå", "yålå", "swag", "sväg", "swäg", "meme", "feminis", "patriarkat", "bajsrunk", "oskar", "suicide", "$uicide"}
