...
func main() {
	...
	NICK := "faggotbot"
	CHANNEL := "#laidback"
	bannedwords := []string{"java", "xD", "facebook", "tumblr", "haha aa", "bajsar", "skiter", "haha mm", "kek", "pepsi max", "SSD är värdelös", "dkn ingen fv", "9gag", "flash xss", "jag bor i stockholm", "steam", "löfven", "romson", "fridolin", "schyman", "kolbit", "hipster", "åkesson", "deepweb", "norton", "antivirus", "ebin", "yolo", "jålå", "yålå", "swag", "sväg", "swäg", "meme", "feminism", "feminist", "patriarkatet", "patriarkat", "kränkt", "enema", "mema", "bajsrunk"}
